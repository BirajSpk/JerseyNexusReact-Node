...
const KhaltiFailed = () => {
  ...
  useEffect(() => {
    ...
    if (urlReason) {
      ...
      switch (errorParam) {
        case 'payment_not_found':
          ...
          break;
        case 'callback_error':
          reason = 'Payment processing error occurred';
          break;
        default:
          reason = `Payment error: ${errorParam}`;
      }
    } else if (statusParam) {
    ...
    toast.error(`Khalti Payment Failed: ${reason}`);
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50">
      <div className="max-w-md w-full bg-white rounded-lg shadow-lg p-8 text-center">
        ...
        <h1 className="text-2xl font-bold text-gray-900 mb-2">Khalti Payment Failed</h1>
          ...
          <div className="flex items-start">
            ...
            <div className="text-left">
              ...
              <p className="text-sm text-yellow-700 mt-1">
                Your Khalti payment could not be completed. This might be due to:
              </p>
        ...
        <div className="mt-6 pt-6 border-t border-gray-200">
          <p className="text-xs text-gray-500">
            Need help? Contact our support team for assistance with your Khalti payment.
          </p>
        </div>
      </div>
    </div>
